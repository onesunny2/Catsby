...
/* 📌 작업 순서
 ...
 < 2페이즈 > 탭바컨트롤러☑️ - 오늘의영화(최근검색어X)☑️ - 닉네임 수정화면☑️ - 영화 좋아요 기능☑️ -  오늘의영화(최근검색어O) - 검색결과화면 - 영화상세화면☑️ - 설정화면 - 프로필 수정 모달☑️
 < 3페이즈 >
 ...
 10. 메인화면에서 무비박스 갯수 달라지는거 탭해서 설정화면가도 반영되는지 확인 필요
 11. 상세화면에서 돌아왔을 때 무비박스 갯수 반영되도록
